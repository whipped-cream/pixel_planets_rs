...
pub(crate) struct PlanetUnder {
    #[uniform(0)]
    pub(crate) params: PlanetUnderUniform
}
#[derive(ShaderType, Debug, Clone)]
pub(crate) struct PlanetUnderUniform {
...
impl Material2d for PlanetUnder {
    fn fragment_shader() -> ShaderRef { "shaders/landmasses/planetunder.wgsl".into() }
}