...
pub struct BaseParams {
    ...
    pub colors: [LinearRgba; 3], // TODO: I should use a Vec here because the number of colors can be variable. but theres two sets of colors which is annoying
    pub dark_colors: [LinearRgba; 3],
    pub num_colors: u32,
    pub size: f32,
    pub seed: f32,
    pub octaves: u32
    ...
    fn from(value: &BandedGasGiantParams) -> Self {
        Base {
            params: BaseUniform {
                ...
                colors: value.base_layer_params.colors,
                dark_colors: value.base_layer_params.dark_colors,
    ...
    fn from(value: &BandedGasGiantParams) -> Self {
        Ring {
            params: RingUniform {
                ...
                colors: value.ring_params.colors,
                dark_colors: value.ring_params.dark_colors,
